...
# Title: Dsss Sim Perfekt Sync Fg Without Fec
# Author: Kristian Maier
# Generated: Wed Jun 14 09:13:25 2017
##################################################
import threading
...
class dsss_sim_perfekt_sync_fg_without_fec(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ebn0_db=3, spread_factor=2**10, tailbiting=True):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsss_sim_perfekt_sync_fg_without_fec")
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.lpwan_dsss_interleaver_bb_0, 0))
        ...
        self.connect((self.lpwan_dsss_deinterleaver_ff_0, 0), (self.blocks_float_to_complex_0, 0))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ebn0-db", dest="ebn0_db", type="intx", default=3,
...
def main(top_block_cls=dsss_sim_perfekt_sync_fg_without_fec, options=None):
    if options is None:
